            ...
            <Card sx={{ position: 'relative', height: 400 }}>
              ...
              >
                <Typography variant="h4" sx={{ fontWeight: 'bold', fontFamily: 'Roboto Mono, monospace' }}>
                  THE BATTLE BEGINS: 8 TEAMS. 1 GLORY.
                </Typography>
                <Typography variant="subtitle1" sx={{ fontFamily: 'Roboto Mono, monospace' }}>
                  Electric moment! EWI blazes through four defenders like lightning, smashing home a stunning goal to ignite A1's title charge!
                </Typography>
