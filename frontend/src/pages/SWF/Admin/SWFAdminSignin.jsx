...
const SWFAdminSignin = () => {
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      ...
      navigate('/student-week-football/admin-dashboard');
    } catch {
      setError('Please check your credentials or internet connection.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    ...
    >
      <Typography variant="h4" sx={{ mb: 3, fontFamily: 'Roberto Mono, Monospace' }}>
        STUDENT WEEK FOOTBALL Admin Sign In
      </Typography>
