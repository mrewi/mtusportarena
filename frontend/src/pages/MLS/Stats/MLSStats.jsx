...
const MLSStats = () => {
  ...
  const statsData = [
    ...
    { sn: 2, name: 'Zino', club: 'Olukoya Stars', goals: 9, assists: 1, yellowCards: 0, cleanSheets: 0 },
    { sn: 2, name: 'Delight', club: 'Olukoya Stars', goals: 0, assists: 1, yellowCards: 1, cleanSheets: 0 },
    { sn: 2, name: 'Cabaman', club: 'Olukoya Stars', goals: 0, assists: 1, yellowCards: 0, cleanSheets: 2 },
    { sn: 2, name: 'Ipetan', club: 'Olukoya Stars', goals: 5, assists: 8, yellowCards: 0, cleanSheets: 0 },
    ...
    { sn: 3, name: 'Aderonmu Segun', club: 'Olurin United', goals: 0, assists: 3, yellowCards: 2, cleanSheets: 0 },
    ...
    { sn: 3, name: 'Rashford', club: 'Ayolabi Boys', goals: 1, assists: 2, yellowCards: 0, cleanSheets: 0 },
